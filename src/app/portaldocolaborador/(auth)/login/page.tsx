...
export default function LoginPage() {
  return (
    <div className="flex items-center justify-center w-full h-full border">
      {/* first part */}
      <div className="items-center justify-center hidden w-1/2 min-h-full md:flex text-primary">
        <div className="w-52">
      ...
      {/* second part */}
      <div className="flex flex-col items-center justify-center w-full min-h-full gap-5 text-white bg-primary md:w-1/2">
